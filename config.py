...
API_KEY = "UUoAOaCY1C5bs2z72qwuRNd"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
BAIDU_CLOUD_API_KEY = 'fUUoAOaCY1C5bs2z72qwuRNd'
BAIDU_CLOUD_SECRET_KEY = 'rLjOfsYtu7o7KnUIS77ksbHtVzH1VZv8'
BAIDU_CLOUD_QIANFAN_MODEL = 'ERNIE-Bot-4'    # 可选 "ERNIE-Bot-4"(文心大模型4.0), "ERNIE-Bot"(文心一言), "ERNIE-Bot-turbo", "BLOOMZ-7B", "Llama-2-70B-Chat", "Llama-2-13B-Chat", "Llama-2-7B-Chat", "ERNIE-Speed-128K", "ERNIE-Speed-8K", "ERNIE-Lite-8K"
